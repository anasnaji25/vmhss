...
class SendMarkListView extends StatefulWidget {
  const SendMarkListView({super.key});

  @override
  State<SendMarkListView> createState() => _SendMarkListViewState();
}

class _SendMarkListViewState extends State<SendMarkListView> {
  var examName;
  var isLoading = false;
  var staff;
  var section;
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    examManageController.getwhatssapMessage(
                                        examName.examName,
