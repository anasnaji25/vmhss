...
class ManageFeeStructureView extends StatefulWidget {
  const ManageFeeStructureView({super.key});

  @override
  State<ManageFeeStructureView> createState() => _ManageFeeStructureViewState();
}

class _ManageFeeStructureViewState extends State<ManageFeeStructureView> {
  var examName;
  var isLoading = false;
  var staff;
  var section;
